...
public class AsyncTestFixture : AbstractCompilerTestCase {
  ...
  [Test]
  public void async_delegates() { RunCompilerTestCase(@"async-delegates.boo"); }
  ...
  [Test]
  public void await_switch() { RunCompilerTestCase(@"await-switch.boo"); }

  [Test]
  public void await_void() { RunCompilerTestCase(@"await-void.boo"); }
  ...
  public void conformance_overload_resolution_class_generic_regular_method() {
    RunCompilerTestCase(
        @"conformance-overload-resolution-class-generic-regular-method.boo");
  }

  [Test]
  public void cs_bug_602246() { RunCompilerTestCase(@"cs-bug-602246.boo"); }

  [Test]
  public void cs_bug_748527() { RunCompilerTestCase(@"cs-bug-748527.boo"); }

  [Test]
  public void delegate_async() { RunCompilerTestCase(@"delegate-async.boo"); }
  ...
  [Test]
  public void generic() { RunCompilerTestCase(@"generic.boo"); }

  [Test]
  public void hoist_structure() { RunCompilerTestCase(@"hoist-structure.boo"); }

  [Test]
  public void hoist_using_1() { RunCompilerTestCase(@"hoist-using-1.boo"); }

  [Test]
  public void hoist_using_2() { RunCompilerTestCase(@"hoist-using-2.boo"); }

  [Test]
  public void hoist_using_3() { RunCompilerTestCase(@"hoist-using-3.boo"); }
  ...
  [Test]
  public void inference() { RunCompilerTestCase(@"inference.boo"); }

  [Test]
  public void init() { RunCompilerTestCase(@"init.boo"); }
  ...
  [Test]
  public void my_task_2() { RunCompilerTestCase(@"my-task-2.boo"); }

  [Test]
  public void my_task() { RunCompilerTestCase(@"my-task.boo"); }

  [Test]
  public void premature_null() { RunCompilerTestCase(@"premature-null.boo"); }

  [Test]
  public void property() { RunCompilerTestCase(@"property.boo"); }

  [Test]
  public void struct_async() { RunCompilerTestCase(@"struct-async.boo"); }
  ...
  protected override string GetRelativeTestCasesPath() { return "async"; }
}
}
