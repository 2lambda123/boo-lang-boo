...
internal struct HResult : IEquatable<HResult> {
  ...
  private HResult(uint value) { this.value = value; }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static explicit
  operator HResult(int value) => new HResult(unchecked((uint)value));
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static explicit
  operator int(HResult hresult) => unchecked((int)hresult.value);

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static explicit operator uint(HResult value) => value.value;

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static bool operator ==(HResult left, HResult right) => left.value
                                                                 == right.value;
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public Exception
  CreateException(string message) => new Win32Exception((int)Code, message);
  ...
  public override bool Equals(object obj) => obj is HResult &&
                                             Equals((HResult)obj);
