...
internal class ByRefType : IType {
  public ByRefType(IType baseType) { _type = baseType; }
  ...
  public IEntity GetDefaultMember() { return _type.GetDefaultMember(); }

  public IType[] GetInterfaces() { return _type.GetInterfaces(); }

  public IEnumerable<IEntity> GetMembers() { return _type.GetMembers(); }

  public int GetTypeDepth() { return _type.GetTypeDepth(); }
  ...
  public bool IsSubclassOf(IType other) { return _type.IsSubclassOf(other); }

  public IArrayType MakeArrayType(int rank) {
    return _type.MakeArrayType(rank);
  }

  public IType MakePointerType() { return _type.MakePointerType(); }
