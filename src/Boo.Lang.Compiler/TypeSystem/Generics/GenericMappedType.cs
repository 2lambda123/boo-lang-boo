...
public class GenericMappedType : IGenericMappedType {
  ...
  private static Dictionary<KeyValuePair<IType, GenericConstructedType>,
                            GenericMappedType> _cache =
      new Dictionary<KeyValuePair<IType, GenericConstructedType>,
                     GenericMappedType>();

  public static GenericMappedType
  Create(IType sourceType, GenericConstructedType containingType) {
    var pair = new KeyValuePair<IType, GenericConstructedType>(sourceType,
                                                               containingType);
  ...
  protected GenericMappedType(IType sourceType,
                              GenericConstructedType containingType) {
    if (sourceType.DeclaringEntity !=
        ((IConstructedTypeInfo)containingType).GenericDefinition)
  ...
  public int GetTypeDepth() { return _sourceType.GetTypeDepth(); }
  ...
  public IType[] GetInterfaces() {
    return Array.ConvertAll(_sourceType.GetInterfaces(),
