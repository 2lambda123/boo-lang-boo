...
public class GenericMappedType : IGenericMappedType
{
    ...
    {
        get {
            return _containingType.GenericMapping;
        }
    }
    ...
    {
        get {
            return _sourceType.GenericInfo;
        }
    }
    ...
    {
        get {
            return _sourceType.IsInterface;
        }
    }
    ...
    {
        get {
            return _sourceType.IsValueType;
        }
    }
    ...
    {
        get {
            return GenericMapping.MapType(_sourceType.BaseType);
        }
    }
    ...
    {
        get {
            return GenericMapping.MapType(_sourceType.ElementType);
        }
    }
    ...
    {
        get {
            return _sourceType.IsGenericType;
        }
    }
    ...
    {
        get {
            return _sourceType.GenericDefinition;
        }
    }
}
}
