...
public static class CompilationHelper {
  ...
  public static MethodInfo GetEntryPoint(this Assembly asm) =>
      asm.DefinedTypes
          .SingleOrDefault(
              t => t.GetCustomAttribute<EntryPointTypeAttribute>() != null)
          ?.DeclaredMethods?.Single(
              t => t.GetCustomAttribute<EntryPointAttribute>() != null);
  ...
  GetGeneratedAssembly(this CompilerContext ctx) => ctx.GeneratedAssembly;
#endif
}
}
