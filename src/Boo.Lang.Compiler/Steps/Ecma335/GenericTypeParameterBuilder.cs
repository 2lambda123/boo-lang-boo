...
internal class GenericTypeParameterBuilder {
  ...
  public GenericTypeParameterBuilder(IGenericParameter entity, IBuilder parent,
  ...
  public void Build() {
    ...
    var handle = asm.AddGenericParameter(_parent.Handle, _attrs,
                                         asm.GetOrAddString(_entity.Name),
                                         _entity.GenericParameterPosition);
