...
internal class TypeSystemBridge
{
    ...
    public TypeReferenceHandle ObjectType {
        get;
    }

    private readonly Func<IType, Expression, object> _getValue;

    public IType VoidTypeEntity {
        get;
    }
    public IType TypeTypeEntity {
        get;
    }
    public IType EnumTypeEntity {
        get;
    }
    public IType ValueTypeEntity {
        get;
    }
    public IType ObjectTypeEntity {
        get;
    }

    public MetadataBuilder AssemblyBuilder {
        get;
    }
    public MetadataBuilder DebugBuilder {
        get;
    }
    public ImportScopeHandle NullImportHandle {
        get;
    }
